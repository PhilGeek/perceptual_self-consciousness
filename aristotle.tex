...
Though a close paraphrase of the opening \emph{aporia}, part of what makes the representation schematic is that it leaves key terms whose interpretation is contested untranslated. 
...
These readings are, of course, not unrelated. \textsc{The Perceiver Reading} is perhaps the most natural, flat-footed reading of \emph{to horōn} considered out of context. So understood, \emph{to horōn} is perhaps better translated as ``the seer'', being the animal that sees. ``That which sees'' would be awkward on \textsc{The Perceiver Reading} to say the least (compare describing one's mother, a housewife, as that which cleans). I doubt that it is in play in our passage (\emph{De Anima} 3.2 425b17–20), but it is worth making explicit since, on the other readings, the power, activity, or corporeal instrument count as \emph{to horōn} insofar as they are the power, activity, or corporeal instrument of the seer relevant to their seeing what they do. Thus on \textsc{The Power Reading}, that which sees is the power, sight, that is enabling the perceiver to see what they do. \textsc{The Activity Reading} is perhaps the least natural at first blush. On that reading, \emph{to horōn} is the seeing, the exercise of the power, sight, that enables the perceiver to see what they do. What recommends it to \citet[]{caston02}
