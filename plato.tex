...
\begin{quotation}
	...
	Then mark what a strange statement it is that we are attempting to make, my friend: for if you will consider it as applied to other cases, you will surely see——so I believe——its impossibility. (\emph{Charmides} 167b—c; \citealt[57]{Lamb:1927qw})
\end{quotation}
