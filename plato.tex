...
Doubling is intransitive. A double of other doubles is not double of what other doubles double. The intransitivity of a double of other doubles and itself is not a means to establish its impossibility. The only available means to establish the impossibility is that the double, being double itself, is also, at the same time, half. But then it is not the failure of transitivity so much as reflexivity that is the source of the impossibility.

The remaining quantitative powers are enumerated emphasizing the way something must be in order for the power to apply. What is more than itself must be less than itself, the heavier will be lighter, the older younger (168c9–10). It is at this point that the general conclusion is drawn: whatever has its own power applied to itself will have the nature or being to which this power is applicable (168d1–5).
