...
\begin{quote}
	\emph{Critias}: There you are, Socrates, he said: you push your investigation up to the real question at issue—in what \emph{sōphrosunē} differs from all the other knowledges—but you then proceed to seek some resemblance between it and them; whereas there is no such thing. (\emph{Charmides} 166b7–c1; \citealt[53]{Lamb:1927qw}, modified.)
\end{quote}	
...
\begin{enumerate}[(1)]
	\item itself (\emph{autēs} 167d4)
	\item other hearings
	\item their absence (\emph{tōn mē akoōn} 167d5)
...
Suppose that knowledge and actuality are linked. Suppose, further, that they are linked in that part of what it is to be knowledge is for it to be actual, in some suitable sense. That the possession of knowledge is the realization of epistemic development is a way in which knowledge and actuality are linked. The actual and the potential are spoken of in many ways (\emph{Metaphysica} {\sbl Θ} 1). So what counts as actual can vary in different practical circumstances. Thus if knowledge is linked with actuality, knowledge attributions would vary as well. In the practical circumstances that make salient the first actuality of knowledge (for example when the learned is contrasted with the ignorant if educable), knowledge is attributable. But in practical circumstances that make salient the second actuality, the actualization of action potential of knowledge (for example when our two auditioning musicians are contrasted), there is some pressure to withdraw the knowledge attribution if the power is not exercised, or irregularly exercised with difficulty. This too would be a way in which knowledge and actuality are linked. So knowledge being spoken of in many ways is inherited, at least in part, from the actual and the potential being spoken of in many ways, given the link between knoweldge and actuality.
...
%
% The first alternative begins with Socrates' emphasis on the proper objects of the ordinary psychic powers. Thus color is the proper object of vision just as sound is the proper object of audition. A denial related to this claim is the source of the impossibility. First consider the analogues of \emph{sōphrosunē} that results from applying Critias' account to these psychic powers, for example, a vision that sees itself and other visions and their lack. It is the denial that this hypothetical form of vision sees color that is deemed impossible. Or consider the analogue of \emph{sōphrosunē} that results from applying Critias' account to audition, a hearing that hears itself and other hearings and their lack. It is the denial that this hypothetical form of hearing hears sound that is deemed impossible. It is the failure of the hypothetical analogues of \emph{sōphrosunē} to take the proper objects of their correlative psychic powers, and not their reflexivity, that is the source of the impossibility (compare \citealt[212–4]{Tuozzo:2011aa}). It is the consequent intransitivity or nontransparency, the intrusion of opacity into sensory consciousness, that Critias finds incredible.
%
...
The discussion of the puzzling disanalogies may not pin the blame on any formal feature of Critias' account of \emph{sōphrosunē} for the impossibility (\emph{adunaton}) that results when that account is applied to a range of familiar psychic powers, but The Argument from Relatives (168b2–169c2) does. It is the alleged reflexivity of \emph{sōphrosunē}, its power to be of something as applied to itself that is, if not impossible, then raises serious doubts (168e)

Socrates inaugurates the further inquiry with the statement of a general principle:
\begin{quote}
	\emph{Socrates}: Well now, knowledge as such [{\sbl αὐτη}] is knowledge of something and has some power to be of something—hasn't it? (\emph{Charmides} 168b2–3)
\end{quote}
...
First, though, notice that the power to take an object is expressed in the Greek with a genitive construction (\emph{tinos}). But this genitive construction has broader application in Greek than in English. It includes not only the power of knowledge to be of something, but the power of the greater to be greater than the smaller. So intentional psychic powers are a subset of things that are or have the power to be of something.

After discussion of some quantitative cases (magnitudes, numbers and the like 168e5–7), this general principle is elaborated upon. Things that have the power to be of something are only of things with a certain nature or being (\emph{ousia}). So whatever has its own power applied to itself must itself have the relevant nature or being:
\begin{quotation}
	\emph{Socrates}: So whatever has its own power applied to itself will also have the being (\emph{ousia}) to which its power was applicable, will it not? For instance, hearing is, as we say, just a hearing of sounds, is it not?
	
	\emph{Critias}: Yes. (\emph{Charmides}, 168d1–5; \citealt[63]{Lamb:1927qw}, modified)
\end{quotation}

On this basis, an argument against reflexivity seems only to require one further step: The denial that the power, or the activity that it gives rises to, has the characteristic nature or being of what the power is of. Consider one of Socrates' own examples. Being colored is the characteristic nature or being of the objects of sight. Neither sight nor seeing are colored. So sight could not be of sight or seeing.

The Argument from Relatives (168b2–169c2) is developed over two stages. After the first general principle is stated—that some things have the power to be of something (\emph{tinos})—quantitative cases of this kind are considered on the basis of which the general principle is elaborated—things that have the power to be of something are only of things with a certain nature or being (\emph{ousia}) (168b2–d3). After the general principle is elaborated, these are applied to perceptual powers, hearing and seeing (168d3–169c2). These are, of course, intentional psychic powers. And at the conclusion of the argument, Socrates mentions, in addition, certain natural powers—the power to move, the power to burn, and the like.

Let a relative be something which possesses the power to be of or than something (\emph{tinos}). The terminology may be Peripatetic but the discussion of relatives in \emph{Categoriae} and \emph{Metaphysica} {\sbl Δ} are clearly inspired by the \emph{Charmides}. And let a relative power be a power the possession of which makes something a relative. The relative powers discussed in the Argument from Relatives are:
\begin{enumerate}[(1)]
	\item The quantitative (magnitudes, numbers and the like):
	\begin{enumerate}
		\item the power to be greater than the lesser
		\item the power to be double the half
		\item the power to be more than the less
		\item the power to be heavier than the lighter
		\item the power to be older than the younger
	\end{enumerate}
	\item The intentional:
	\begin{enumerate}
		\item the power to hear sound
		\item the power to see color
	\end{enumerate}
	\item The natural:
	\begin{enumerate}
		\item the power of motion to move something
		\item the power of heat to burn something
	\end{enumerate}
\end{enumerate}
