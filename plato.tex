...
The third perceptual case may not perfectly parallel Critias' account of the content of \emph{sōphrosunē}. How exactly it departs from that account depends upon how our passage (167d4–6) is interpreted.

First, the Socratic refinement goes unmentioned. While the sense is of itself and the other senses no mention is made of it also being of their lack. At least on the first reading, the Socratic refinement is intelligible, and it is open to undersand Socrates' query as elliptical, the refinement not explicitly stated but implicitly understood. So what would be impossible, among other things, is a sense of smell that does not smell what other smellings smell but only itself and other smellings and their lack. But on the second reading, where Socrates is proleptically anticipating \emph{koinē aisthēsis}, this is harder to maintain. Can the perceiver sense the absence of sensing? What exactly are we imagine their experience to be like? Are we to imagine them as conscious while the operation of all their senses are disengaged, like Avicenna's Flying Man? But all the while imagining this to be a mode of sensory consciousness?
