...
\begin{quotation}
	...
	Well, I said, what all this comes to, if your last statement was correct, it is merely that there is one science which is precisely a science of itself and other the other sciences, and moreover is a science of the lack of science at the same time.
	
	Certainly.
	
	Then mark what a strange [\sbl{ἄτοπον}] statement it is that we are attempting to make, my friend: for if you will consider it as applied to other cases, you will surely see——so I believe——its impossibility [\sbl{ἀδύνατον}]. (\emph{Charmides} 167b—c; \citealt[57]{Lamb:1927qw})
\end{quotation}
