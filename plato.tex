...
As to Tuozzo's complaint against Caston, while contemporary orthodoxy may hold that knowledge is stative as opposed to episodic, knowledge might be spoken of in many ways. If the action potential of knowledge is never actualized or actualized only with difficulty, then there is some pressure to withdraw the knowledge attribution. A band leader asks ``Do you know Billy's Bounce?'' One musician says yes and immediately plays the head with good phrasing and rhythm. Another says yes and begins to recollect the head, ``Let' see, it's an F blues... How does it go again? Oh yeah, fifth, um, sharp eleven, fifth, and then root, flat third, natural third, root, six, I got this...'' It would not be unreasonable for the band leader to conclude that the latter does not know the tune, despite being able to recollect it with effort, and should be sent back to the shed. The former knows the tune in a way that the latter does not as evinced by their mastery of it. Aristotle makes this thought explicit in \emph{De Anima} 2.5. 
