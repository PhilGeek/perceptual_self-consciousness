...
\begin{enumerate}[(1)]
	\item Perception has the power to be of something.
	\item In order for the power of perception to be of something it must have a certain nature or being.
	\item So if perception is reflexive and its power to be of something is applied to itself, it must have the requisite nature or being.
	\item But perception lacks the requisite nature or being.
	\item So perception's power to be of something does not admit of a reflexive application.
\end{enumerate} 
